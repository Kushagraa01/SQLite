...
-- insert
INSERT INTO CUSTOMERS(number,first_name,last_name,address,grade) VALUES (1, 'Amor', 'Yadav','Russia', 100);
...
INSERT INTO CUSTOMERS(number,first_name,last_name,address,grade) VALUES (6, 'Aitor', 'Kushwaha','Japan',60);
INSERT INTO CUSTOMERS(number,first_name,last_name,address,grade) VALUES (7, 'Akor', 'Sinha','New York',150);
...
INSERT INTO CUSTOMERS(number,first_name,last_name,address,grade) VALUES (11, 'Arush', 'Kesharwani','New York',70);
...
SELECT * FROM CUSTOMERS
WHERE first_name LIKE "A%" AND first_name LIKE "%or%";